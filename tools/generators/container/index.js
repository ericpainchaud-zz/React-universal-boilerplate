...
module.exports = {
  ...
  actions: data => {
    ...
    const actions = [
      {
        type: 'add',
        path: '../../common/containers/{{properCase name}}/{{properCase name}}.js',
        templateFile: './container/es6.js.hbs',
        abortOnFail: true,
      },
      {
        type: 'add',
        path: '../../common/containers/{{properCase name}}/index.js',
    ...
    if (data.wantCSS) {
      actions.push({
        type: 'add',
        path: '../../common/containers/{{properCase name}}/{{properCase name}}.css',
    ...
    if (data.wantF1) {
      actions.push({
        type: 'add',
        path: '../../common/containers/{{properCase name}}/{{properCase name}}F1States.js',
        templateFile: './container/F1States.js.hbs',
        abortOnFail: true,
      });
      actions.push({
        type: 'add',
        path: '../../common/containers/{{properCase name}}/{{properCase name}}F1Transitions.js',
    ...
    actions.push({
      type: 'add',
      path: '../../common/containers/{{properCase name}}/{{ camelCase name }}Actions.js',
    ...
    actions.push({
      type: 'add',
      path: '../../common/containers/{{properCase name}}/{{ camelCase name }}ActionTypes.js',
    ...
    actions.push({
      type: 'add',
      path: '../../common/containers/{{properCase name}}/{{ camelCase name }}Reducer.js',
      templateFile: './container/reducer.js.hbs',
      abortOnFail: true,
    });
    actions.push({ // Add the reducer to the reducer.js file
      type: 'modify',
      path: '../../common/store/reducers.js',
      pattern: /(routing,\n\s{0,}}\);)/gi,

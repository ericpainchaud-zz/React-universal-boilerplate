...
module.exports = {
  ...
  actions: data => {
    ...
    const actions = [
      {
        type: 'add',
        path: '../../common/components/{{properCase name}}/{{properCase name}}.js',
        templateFile: data.type === 'ES6 Class' ? './component/es6.js.hbs' : './component/stateless.js.hbs',
        abortOnFail: true,
      },
      {
        type: 'add',
        path: '../../common/components/{{properCase name}}/index.js',
    ...
    if (data.wantCSS) {
      actions.push({
        type: 'add',
        path: '../../common/components/{{properCase name}}/{{properCase name}}.css',
    ...
    if (data.wantF1 && data.type === 'ES6 Class') {
      actions.push({
        type: 'add',
        path: '../../common/components/{{properCase name}}/{{properCase name}}F1States.js',
        templateFile: './component/F1States.js.hbs',
        abortOnFail: true,
      });
      actions.push({
        type: 'add',
        path: '../../common/components/{{properCase name}}/{{properCase name}}F1Transitions.js',
